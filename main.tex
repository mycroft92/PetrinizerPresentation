...
\author{J. Esparza, Ledesma-Garza R., Majumjumdar R., Meyer P., Niksic F.}
...
\begin{frame}{Petri Nets}{Optional Subtitle}
  Recall:
  \begin{itemize}
  \item \textbf{Petri Net} is a tuple \textit{(P,T,F,$m_0$)}
    \begin{itemize}
